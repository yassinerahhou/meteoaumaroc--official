...
export const translations: Record<Locale, Translations> = {
  fr: {
    ...
    "hero.subtitle":   "Météo actuelle, prévisions 5 jours et alertes pour plus de 60 villes marocaines.",
  ...
  ar: {
    ...
    "hero.subtitle":   "الطقس الحالي، توقعات 5 أيام والتنبيهات لأكثر من 60 مدينة مغربية.",
  ...
  en: {
    ...
    "hero.subtitle":   "Current weather, 5-day forecasts and alerts for 60+ Moroccan cities.",

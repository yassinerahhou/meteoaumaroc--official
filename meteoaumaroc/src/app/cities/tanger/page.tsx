...
const TangierPage: React.FC = () => {
  const cityName = "Tangier";
  const lat = 35.7673; // Latitude for Tangier
  const lon = -5.7998; // Longitude for Tangier

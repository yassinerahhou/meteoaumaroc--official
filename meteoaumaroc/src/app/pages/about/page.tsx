      ...
      <div className={styles.content}>
        ...
        <div className={styles.termsContent}>
          <p className={styles.intro}>
            ...
            confiance pour obtenir des prévisions météo précises et mises à jour
            en temps réel pour le Maroc et au-delà. Nous sommes dédiés à fournir
            des informations météorologiques fiables, faciles à comprendre et
            accessibles à tous. Que vous soyez un voyageur, un professionnel ou
            tout simplement curieux de connaître la météo, notre site vous aide
            à planifier vos activités en toute sérénité.
          </p>

          <div className={styles.section}>
            <h2 className={styles.sectionTitle}>Notre Mission</h2>
            <p>
              Chez <strong>MeteoAuMaroc.com</strong>, notre mission est de vous
              offrir une vision claire et précise des conditions météorologiques
              actuelles et futures, non seulement pour le Maroc, mais aussi pour
              les grandes villes à travers le monde. Nous croyons que
              l'information météorologique doit être simple, utile et à jour,
              pour améliorer votre quotidien, quel que soit l'endroit où vous
              vous trouvez.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                Des graphiques interactifs pour suivre les tendances climatiques
              </li>
              <li>
                Un blog régulièrement mis à jour avec des articles sur la météo
                et l'environnement
              </li>
              <li>
          ...
          <div className={styles.section}>
            ...
            <p>
              ...
              compétences pour vous fournir des données météorologiques exactes
              et pertinentes, tout en veillant à l'accessibilité et à la
              fluidité de notre plateforme. Chaque membre de notre équipe
          ...
          <div className={styles.section}>
            ...
            <p>
              ...
              climatique, et notre équipe travaille sans relâche pour s'assurer
              que vous obteniez les informations les plus récentes. De plus,
              nous adaptons notre contenu en fonction de vos préférences pour
